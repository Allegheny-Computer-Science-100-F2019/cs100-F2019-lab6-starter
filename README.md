...
this repository will initially fail, as evidenced by a red &#x2717; instead of
a green &#x2714; of appearing in the commit logs. An instructor would use this
...
will check to ensure that `ManipulateDna` produces exactly ten lines of
...
that will differ from the instructor's version of `ManipulateDna`. As long as your
...
purpose of the `ManipulateDna` program is to effectively hide an input word in a grid
...
```
Gregory M. Kapfhammer Thu Oct 21 10:19:43 EDT 2019
...
- The ManipulateDna.java in src/main/java/labsix has at least 1 of the `public class ManipulateDna` fragment
- The ManipulateDna.java in src/main/java/labsix has at least 4 single-line Java comment(s)
- The ManipulateDna.java in src/main/java/labsix has exactly 0 of the `Add Your Name Here` fragment
- The ManipulateDna.java in src/main/java/labsix has exactly 0 of the `TODO` fragment
- The ManipulateDna.java in src/main/java/labsix has exactly 1 of the `import java.io.File;` fragment
- The ManipulateDna.java in src/main/java/labsix has exactly 1 of the `import java.io.FileNotFoundException;` fragment
- The ManipulateDna.java in src/main/java/labsix has exactly 1 of the `import java.util.Date;` fragment
- The ManipulateDna.java in src/main/java/labsix has exactly 1 of the `new Date()` fragment
- The ManipulateDna.java in src/main/java/labsix has exactly 1 of the `package labsix;` fragment
- The ManipulateDna.java in src/main/java/labsix has exactly 2 multiple-line Java comment(s)
- The command `gradle -q --console plain run` executes correctly
- The command `gradle build` executes correctly
- The command output has exactly 8 lines
- The file ManipulateDna.java exists in the src/main/java/labsix directory
- The file reflection.md exists in the writing directory
- The reflection.md in writing has at least 200 word(s) in total
- The reflection.md in writing has at least 5 of the `heading` tag
...
```
        ┏━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┓
        ┃ Passed 20/20 (100%) of checks for cs100-F2019-lab6! ┃
        ┗━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┛
```
...
```
git remote add download git@github.com:Allegheny-Computer-Science-100-F2019/cs100-F2019-lab6-starter.git
```
...
5](https://github.com/Allegheny-Computer-Science-100-F2019/cs100-F2019-lab6-starter)
repository and [raise an
issue](https://github.com/Allegheny-Computer-Science-100-F2019/cs100-F2019-lab6-starter/issues).
